...
public class Amount2RMBUtils {

    private static Logger logger = LoggerFactory.getLogger(Amount2RMBUtils.class);
    ...
    public static void main(String[] args) {
        logger.info("{}", "壹万陆仟肆佰零玖元零贰分".equals(convert("16,409.02")));
        logger.info(convert("1264.90"));
    }
}
